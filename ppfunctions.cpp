...
void PP::draw_board()
{
    ...
    sprintf(l_point, "%d", player_points[0]);
    sprintf(r_point, "%d", player_points[1]);
    sprintf(rally_num, "%d", rally_counter);

    string l_point_text = l_point;
    string r_point_text = r_point;

    rally_text += rally_num;
